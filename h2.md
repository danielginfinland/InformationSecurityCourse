...
The Daniel´s Company implements quarterly Audits to check the company´s security. We will also hire persons and companies to do penetration tests at our systems. Their will also be a taskforce that is in charge of use continuisly Threat Modeling to detect threats and improve the company´s security. 
