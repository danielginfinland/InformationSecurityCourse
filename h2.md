...
b) The company´s name in this case study is Ghodrati Company. Stakeholders are the board, the employees and the customers. Ghodrati Company sells B2C software solutions. These include and application with several additional licences that the customers may buy.
