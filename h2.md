...
## b) Thread Modeling on the example of the fictive Ghodrati Company 


The company´s name in this case study is Ghodrati Company. Stakeholders are the board, the employees and the customers. Ghodrati Company sells B2C software solutions. These include and application with several additional licences that the customers may buy.
...
An expected happening os Spoofing. It´s a really easy way to attack the system. 
Also DoS is quite probable. The expected value of this attack will be 0.4 % * 50,000 €/d = 20,000 €/d. The high price of 50,000 is because of the loss of trust of the customer in the company and the reliability of it. 
