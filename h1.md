...
The Courses of Action Model measures the performance of the action to defend cybersecurity attacks. In each phase of the kill chain, there are actions can be done by the company itself. Each kind of defense is described by one of the 6 D´s: Detect, Deny, Disrupt, Degrade, Deceive, Destroy
